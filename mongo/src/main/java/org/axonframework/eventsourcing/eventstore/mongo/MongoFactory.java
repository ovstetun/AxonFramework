...
public class MongoFactory {
     ...
     * single Mongo instance being used on the default host (<code>127.0.0.1</code>) and port (
     * <code>{@value com.mongodb.DBPort#PORT}</code>)
     * <p/>
     * Defaults to an empty list, which locates a single Mongo instance on the default host (<code>127.0.0.1</code>) and
     * port <code>({@value com.mongodb.DBPort#PORT})</code>
     *
     * @param mongoAddresses
     ...
     *
     * @param mongoOptions
     *            MongoOptions to overrule the default
     */
