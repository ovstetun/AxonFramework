...
public abstract class AuthenticatingMongoTemplate {
     ...
     *
     * @param mongo
     *            The Mongo instance configured to connect to the Mongo Server
     * @param userName
     *            The username to authenticate with. Use <code>null</code> to skip authentication
     * @param password
     *            The password to authenticate with. Use <code>null</code> to skip authentication
     */
    protected AuthenticatingMongoTemplate(MongoClient mongo) { // NOSONAR
     ...
     *            The Mongo instance configured to connect to the Mongo Server
     * @param databaseName
     *            The name of the database containing the data
     */
    protected AuthenticatingMongoTemplate(MongoClient mongo, String databaseName) { // NOSONAR
